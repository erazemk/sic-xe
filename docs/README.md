This site contains various educational materials about the Simplified Instructional Computer (SIC).
Everything is split into chapters, so feel free to skip to whichever parts interest you, there is no mandatory reading order.
...
1. [Cheat Sheet](chapters/cheatsheet.md)
-->

## Project info

The aim of the SIC/XE project is to gather as much documentation and other useful resources about the SIC architecture as possible, including SIC/XE-related projects, such as an example implementation of a SIC/XE compiler, assembler, linker, and simulator, or SIC assembly examples.
If you're interested in the project check out the [GitHub repository](https://github.com/erazemk/sic-xe).
